...
import { AdminProvinceFormComponent } from '../admin-province-form/admin-province-form.component';

@Component({
  selector: 'app-admin-province',
  standalone: false,

  templateUrl: './admin-province.component.html',
  styleUrl: './admin-province.component.scss'
})
export class AdminProvinceComponent implements OnInit, OnChanges {
